...
import {EdiSegment} from './edi-segment/edi-segment';

@Component({
  selector: 'prb-clean-edi-viewer',
  imports: [
    EdiInfoDialog,
    EdiSegment
  ],
  templateUrl: './clean-edi-viewer.html',
  styleUrl: './clean-edi-viewer.scss',
})
export class CleanEdiViewer implements OnInit {
